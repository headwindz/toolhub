          ...
          <div className="space-y-4 text-sm leading-relaxed p-6">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                data-interchange format that's easy for humans to read and
                write, and easy for machines to parse and generate. It's based
                on a subset of JavaScript but is language-independent.
              </p>
            </div>
            <div>
              ...
              <ul className="list-disc space-y-1 text-muted-foreground pl-5">
                <li>
                  <strong>Object:</strong> Unordered collection of key-value
                  pairs enclosed in curly braces{" "}
                  <code className="bg-muted rounded px-1">{`{ }`}</code>
                </li>
                <li>
                  <strong>Array:</strong> Ordered list of values enclosed in
                  square brackets{" "}
                  <code className="bg-muted rounded px-1">[ ]</code>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc space-y-1 text-muted-foreground pl-5">
                <li>
                  <strong>Readability:</strong> Properly indented JSON is much
                  easier to read and understand
                </li>
                <li>
                  <strong>Debugging:</strong> Formatted JSON helps identify
                  structure issues quickly
                </li>
                <li>
                  <strong>Validation:</strong> Formatting tools can detect
                  syntax errors
                </li>
                <li>
                  <strong>Minification:</strong> Removing whitespace reduces
