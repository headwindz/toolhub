        ...
        <div className="space-y-4 text-sm leading-relaxed p-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              any size into a fixed-length digest. Good hashes are
              deterministic, fast to compute, infeasible to invert, and
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-1 text-muted-foreground pl-5">
              ...
              <li>
                <strong>SHA-256 / SHA-512:</strong> Modern choices from the
                SHA-2 family, widely recommended.
              </li>
              <li>
                <strong>MD5:</strong> 128-bit output, broken — avoid for
                security uses.
              </li>
            </ul>
          </div>
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-1 text-muted-foreground pl-5">
              ...
              <li>
                Digital signatures (used within higher-level constructions).
              </li>
              <li>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-1 text-muted-foreground pl-5">
              ...
              <li>
                Prefer SHA-256/512 for general hashing; avoid MD5 and SHA-1 for
                new systems.
              </li>
              <li>
                Use HMAC for authenticity (hash alone does not authenticate
                data).
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-1 text-muted-foreground pl-5">
              <li>
                <strong>Ethereum:</strong> Uses <em>Keccak‑256</em> (often
                called
              ...
              <li>
                <strong>Bitcoin:</strong> Block/Tx IDs use{" "}
                <em>double SHA‑256</em>. Legacy addresses use <em>HASH160</em> =
                RIPEMD‑160(SHA‑256(pubkey)), then Base58Check with a 4‑byte
                checksum.
              </li>
              <li>
                <strong>Merkle trees:</strong> Transactions are hashed pairwise
                up a tree to a <em>merkle root</em> stored in the block header.
                Proofs allow light clients to verify inclusion.
              </li>
              <li>
                <strong>Proof‑of‑Work:</strong> Miners vary a nonce so
                <code>hash(blockHeader)</code> is below a target (difficulty).
                Lower targets require more work.
              </li>
              <li>
                <strong>Signatures:</strong> Ethereum uses secp256k1 ECDSA and
                recovers signer via <code>ecrecover</code>. Prefer
                domain‑separated messages (<strong>EIP‑191</strong>) or typed
                data (<strong>EIP‑712</strong>).
              </li>
              <li>
                <strong>Smart contracts:</strong> Hash with
                <code> keccak256(abi.encode(...))</code> for type‑safety; avoid
                <code> abi.encodePacked(...)</code> with concatenated dynamic
                types due to potential collision ambiguities.
              </li>
              <li>
