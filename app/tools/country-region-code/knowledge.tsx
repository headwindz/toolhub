  ...
  return (
    ...
    >
      <section className="space-y-2">
        <h3 className="font-semibold text-lg">What are Country Codes?</h3>
      ...
      <section className="space-y-2">
        <h3 className="font-semibold text-lg">ISO 3166 Standards</h3>
        <div className="space-y-3">
          <div>
            <strong className="text-foreground">ISO 3166-1 Alpha-2</strong>
            <p className="mt-1 text-muted-foreground">
              Two-letter country codes (e.g., US, GB, JP). Most commonly used in
              domain names, passports, and international vehicle registration
              plates. Widely adopted across the internet and software systems.
            </p>
          </div>
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              ...
              recognizable and less prone to confusion. Used in currency codes,
              flight booking systems, and international trade documentation.
            </p>
          </div>
          <div>
      ...
      <section className="space-y-2">
        <h3 className="font-semibold text-lg">International Calling Codes</h3>
        <p className="text-muted-foreground">
          Also known as country dialing codes or IDD (International Direct
          Dialing) codes. These are telephone number prefixes used when calling
          from one country to another. Format: + followed by 1-3 digits (e.g.,
          +1 for US/Canada, +44 for UK, +86 for China).
        </p>
      </section>
      ...
      <section className="space-y-2">
        <h3 className="font-semibold text-lg">Currency Codes</h3>
        <p className="text-muted-foreground">
          Currency codes follow the ISO 4217 standard. They consist of three
          letters: the first two letters represent the country code (ISO 3166-1
          Alpha-2), and the third letter represents the currency name (e.g., USD
          = US Dollar, EUR = Euro, JPY = Japanese Yen).
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <ul className="space-y-2 text-muted-foreground">
          ...
          <li>
            Multiple countries may share the same calling code (e.g., +1 for US,
