...
import { ArrowLeft, Clock, Globe2, Plus, Trash2, Calendar } from "lucide-react"
        ...
        <div className="mx-auto max-w-5xl space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground">Check corresponding times across different timezones</p>
            </div>
          </div>
