...
import { ArrowLeft, Download, QrCode, Sparkles, LinkIcon } from "lucide-react"
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-lg text-muted-foreground">Transform any text or URL into a scannable QR code</p>
