...
import { ArrowLeft, Hash, Copy, Check, FileText, ChevronDown, BookOpen } from "lucide-react"
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Generate MD5 hash from text input</p>
          </div>
        </div>
          ...
          <Collapsible open={isLearnOpen} onOpenChange={setIsLearnOpen}>
            ...
            <CollapsibleContent>
              <div className="space-y-4 p-6 text-sm leading-relaxed">
                <div>
                  <h4 className="mb-2 font-semibold text-base">What is MD5?</h4>
                ...
                <div>
                  <h4 className="mb-2 font-semibold text-base">Key Characteristics</h4>
                ...
                <div>
                  <h4 className="mb-2 font-semibold text-base">Common Use Cases</h4>
                  <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
                ...
                <div className="rounded-lg border border-yellow-500/50 bg-yellow-500/10 p-4">
                  <h4 className="mb-2 font-semibold text-base text-yellow-900 dark:text-yellow-100">
                    ⚠️ Security Warning
                  </h4>
        ...
        <div className="space-y-6">
          <Card className="overflow-hidden border-2">
            <div className="bg-gradient-to-r from-orange-500/10 to-red-600/10 p-6">
              <Label htmlFor="input" className="mb-2 block text-base font-semibold">
                Input Text
              </Label>
              <Textarea
                id="input"
                ...
                className="min-h-[120px] border-2 bg-background font-mono text-sm"
              />
              ...
              <div className="bg-gradient-to-r from-orange-500/5 to-red-600/5 p-6">
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Label className="text-base font-semibold">MD5 Hash Result</Label>
                  </div>
                ...
                <div className="rounded-lg border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-red-50 p-4 dark:border-orange-900/50 dark:from-orange-950/20 dark:to-red-950/20">
                  <p className="break-all font-mono text-sm font-medium text-orange-900 dark:text-orange-100">{hash}</p>
                </div>
